...
# ==============================================================================
#
# This script is used to run local test on BRAT VOC 2012 using MobileNet-v2.
...
# Go to datasets folder and download BRAT VOC 2012 segmentation dataset.
...
python "${WORK_DIR}"/train.py \
  ...
  --tf_initial_checkpoint="${INIT_FOLDER}/${CKPT_NAME}/mobilenet_v2_1.4_224.ckpt" \
