...
#
# Usage:
#   bash ./download_and_convert_ara_anthoSet.sh
#
# The folder structure is assumed to be:
#  + datasets
#     - build_data.py
#     - build_rosette_data.py
#     - download_and_convert_ara_anthoSet.sh
#     + ara_anthoSet
#       + rosettes
#         + JPEGImages
#         + SegmentationClass
...
# Helper function to download and unpack ara_anthoSet dataset.
...
FILENAME="vgwbomey2rhfh84/ara_anthoSet.tar.gz?dl=1"

download_and_uncompress "${BASE_URL}" "${FILENAME}"

cd "${CURRENT_DIR}"

# Root path for ara_anthoSet dataset.
